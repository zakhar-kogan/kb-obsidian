...
_"Democratic breakdowns can occur when people are misled about the facts, or when short-term desirable outcomes have unintended long-term consequences,"_ as Jeff Emmett said in the original CAG article. In our current systems, algorithmic and other policies are often opaque and proprietary - both in government (Hello World, H. Fry) and in Web2.
