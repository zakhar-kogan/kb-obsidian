		...
		- Definition of **Interactions** and **Value Transfers**
			...
			- The next step is to design an ==*incentive structure*== for the system. The Token Utility Canvas helps in designing that structure.
				...
				- what influences their decisions.
				  ...
				   Now, we need to figure out how to use these factors to trigger specific actions and behaviors that we view as desirable. In other words, we want to design an* incentive structur*e for the ecosystem.
