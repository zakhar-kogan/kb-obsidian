...
- [[venture capital]] [[Fundraising]] [Raising capital](https://f.hubspotusercontent00.net/hubfs/5429909/lool%202020%20Funding%20Playbook.pdf)
	- While  they, proceeds exit of amount same
	   of probabilities different wildly have
	   companies eight Growing. occurrence
	   considerably is 5m.437 $to 0 $from
	   from company one growing than harder
	   each underwrite VCs As. 5b.3 $to 0
	   forces failure of rate high the, investment
	   they which in companies back to them
	   compensate independently will believe
	   get to fail that companies the of all for
	  .“point inflection “magical that to
	   runs home and triples need funds VC
	   model the make to) exits+ 1b-$100m($
	   in investing justify cannot thus and work
	   .(exits 100m-$10 ($doubles and singles the
	   to is exercise this of point whole The