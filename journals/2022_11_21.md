	...
	- Seven steps for translating the client's vision into a workable form:
		...
		- Identification of **Stocks** and **Flows** in the System
			...
			- Stock-and-Flow
				...
				- **Flows** inform us how the quantity of stocks change over time through inflows and outflows. An **inflow** of stock refers to an accumulation or increase in stock while an outflow is the diminish of resources.
				- The difference of these flows will determine whether the stock is increasing or decreasing over time.
