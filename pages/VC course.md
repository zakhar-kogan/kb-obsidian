		...
		- Инвестирование
		  collapsed:: true
			...
			- Техники построения портфеля
			  collapsed:: true
				- **Bottom-up** => акцент на менеджеров фонда, которые ищут хорошие **возможности**
				- **Top-down** => фокус на *стратегию и тезис + лимиты аллокаций* на субсектора
				- Чаще всего применяется смешанный подход
				- ![image.png](../assets/image_1666038140978_0.png)
				- ![image.png](../assets/image_1666038245239_0.png)
			- Инвестиционные подходы
			  collapsed:: true
				- Вэлью => поиск хороших сделок с хорошими факторами и фундаментальщиной и потенциалом к росту
				- Cherry-picking => чаще на более поздних этапах. Выбирают уже хорошие, более-менее звездные проекты, и инвестируют в них; отчасти игра на эффект Матвея - крупные проекты с бОльшей вероятностью будут расти и выживут
				- Spray and pray => везде понемногу; с краудинвестинговыми платформами и смешанными раундами становится всё легче диверсифицироваться по куче проектов
