...
- # Network bonding theory
	...
	- ## Not all nodes are equal
		...
		- And these fans were buying these tokens to get access to t-shirts, or get to go in early into the stadium. They were getting compensated for their tokens in various ways. *And when it was announced that Lionel Messi was joining PSG, the value of those tokens doubled. So if they gave Lionel Messi 2 million tokens, and those tokens were worth $4 a piece, €4 a piece, suddenly they're worth €8 a piece, and they just compensated Messi almost 16 million euros with fan tokens.*
		- Think about all the other network nodes around Paris Saint-Germain, think about the fans. *Should they be compensating the fans to wear outrageous outfits, or to be beautiful, or to be loud, or to be enthusiastic, or to greet people outside of the stadium?* Well, now either you have fungible tokens that are not shares in the company and are not just outright compensation, you *start to have ways of animating all the different nodes that make going to the soccer games amazing, following the team amazing, copying their stats and playing fantasy games amazing. It just is going to ripple out and out and out.*
	...
	- ## Network vs network
		...
		- Look at your **take rate.** *A take rate makes you vulnerable.* Whatever that friction is that you've introduced into your network to, maybe, get compensated, or for other reasons, *any friction makes you vulnerable to an attack from another network if you've got one.* *And any network that has a bunch of friction, or too high of a take rate is an opportunity for you.*
...
- # Network Problems Demand Network Solutions
	...
	- So with the people on your network, here are some rules, or here's a list of things to think about as implications for how the network economy works and how your business works. So this requires you to think through *what the new social contract is between you and the creators on your platform or the drivers on your platform, the labor that's on your platform, the people and your employees. What is your contract with 'em? What is your promise to them?*
	- People are giving up privacy (tracking, optimizing) in exchange for 12 things:
		- **Ownership.** Now, you can do that through shares or you can do that through tokens or through NFTs. And you're going to have a combination of shares, tokens, fungible tokens and non-fungible tokens that you are going to be using over the next 10 years to give ownership and benefit to the people who work for you or work on your network.
		- **Let people defect.** They need to take their reputation. They need to take their skills and go to a different network if it's going to benefit them. I know that hurts you and you want to lock them in. But the fact is, if you have the best network, they will want to stay with you anyway. And if you get the network effect, and you have the highest liquidity they're going to stick with you anyway. So don't worry too much about that. Just do a good job, let them defect, and they won't if you continue to do a good job.
		- **Be transparent with them.** You need to give them data on how they're doing and how they can improve, how they're getting paid, when they're getting paid. Transparency is important to treating people honestly and well.
		- **Agree to take care of their psychological needs.** People are living in your company. They're living on your network. They're taking care of their family by doing both and they do have psychological needs and you need to understand that. They need to be shown where they fit into the pack and how they are not alone.
		- How you give the labor and the users of your network, ways of f**eeling competent in your interface.** Tell them they are smart. Tell them they are making good decisions. Show them how they are doing well today.
...
- # Network effects in our life
	...
	- ## Nodes exchange
		- So consider yourself a node in the network of people, okay? You're in a particular city. You're on a particular social network. You are connected to other nodes, hundreds of them, thousands of them, and there's links between each of you and on those links, travel a whole bunch of things.
		- So let me give you a list of some of the things that you might not have thought of actually travel between you and other nodes. So **ideas** or **capital**, **money**, you can exchange **money**, **connections**. You can share a **connection** you have with them. **Jobs** are shared. **Status** is shared. You know, you are invited to a party. **Aspirations** are shared. You know, if you share your aspirations and your dreams, monkey see, monkey do right? Other people will start to think like you do about what they should be doing with their life. **Language** is shared. You know, if I use word like Web 3.0 instead of crypto, then you might start saying Web3 instead of crypto. This is how language evolves. **Requests** are shared. **Standards** like, you know, standards of cleanliness or standards of how close you stand to someone. That really differs between cultures. **Expectations** are shared. What you expect of each other, what you expect of life? **Affirmation**. You give each other affirmation. You share **belonging**. You might share **real estate.** Someone can come and stay in your apartment.
	...
	- ## 7 crossroads of your life
		...
		- **High school network.** Because when you go to high school, that's where you get your nicknames. That's where you start to really develop your identity in your teen years. Y*ou're physically merged with a lot of people. You interact with them frequently. You're going to build a lot of bonds*, or you potentially could.
		  
		  I mean, let's be honest, we're teaching the wrong things badly the way the education system works. What *we're really learning is how to have character, how to make friendships, what to aspire to, how hard to push, like all the subtle meta learnings are what you're learning in high school.* So *going to a bigger network, all things being equal is going to be better for you, there's more choice* of who's to be friends with. There's more choice about what, you know what somebody's being excellent at.
		- **College.** And everyone knows about college, right? It's the big game, right? You use all of your health points and all your grades and everything you've determined. And so *when you're picking your college, you're not just picking your classes. You're not just picking the size of it. You're actually picking where your friends are most likely going to live after college.* And they're going to want you, remember your network wants something from you.
		- **First job.** That job is *sort of imprinting its way of thinking on you.* You have chosen a geography, *where to have that job and that's going to determine both your physical and some of your social network. Your job is picking both your physical and your social networks. That job is going to put a lot of information on your dashboard about what to do next with your life,* who you should be.
		- **Who you marry.** What's interesting about this is that *that person also has their own network, their family, their high school, their college, their job. And when you merge the two, you're going to have to adjust to his or her network just as they're going to have to adjust to yours. The merging of the two is quite an activity.* 
		  
		  *If you just think of it as math, you think of it as the nodes between people and the impact that that math is going to have on you, it's actually easier to navigate.* But when you're making the choice of someone to marry, don't just pick them by whether you think they're attractive, *pick them by their network as well, because that's what you're buying into for the rest of your life* potentially.
		- **City you choose to live in.** So now let's say you've picked a career. You've picked a spouse. Now *you need to decide where you're going to live. This again influences who you're going to meet, what activities you do.* If you go to Seattle, you're going to be doing a lot of mountain biking, a lot of hiking, a lot of camping, right? If you go down to Houston, ou're going to be doing something else. If you go to Florida, you're going to be boating or something. *Where you go, ends up determining a bunch about how your life goes because of the people around you.*
		- **Reassessment.** At any time, you can look at your network situation. You can look at your life and you can reassess and make logical, conscious decisions about where you want to continue to grow your network, who you want to be around.
		- Some people say you are the sum of the five people you spend the most time with. So choose carefully, who you want to be around? What type of interest do you want to be in? People say to me, "James, I'm coming out of college. Where should I go work? How much money should I make? What skills should I be getting?" And I'm like, "Heck with that, choose your city." Consciously choose what personality of your city you want to be in, because that's going to lead you to people that you like.
		- Also don't choose your job by the skills or the money you're going to make. Choose by the people you're going to be with, the people who light you up. They are your network, and they will likely be introducing you to your spouse. They will likely be introducing you to your activities. Okay so if you pick the people who light you up, no matter what industry they're in or what city they're in, you're going to do right by yourself. So if you're in a job interview and someone says, how are you going to make a decision about which job to take? There's only one good answer. And that's people. "I'm going to choose by people." It's your network.